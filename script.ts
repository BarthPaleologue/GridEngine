...
let renderer = <HTMLCanvasElement>document.getElementById("renderer");
let ctx = renderer!.getContext("2d");

let ui = <HTMLCanvasElement>document.getElementById("UI");
...
document.addEventListener("keydown", e => {
    ...
    if (e.keyCode == 107) game.zoom(1.5);
    if (e.keyCode == 109) game.zoom(1 / 1.5);
});
